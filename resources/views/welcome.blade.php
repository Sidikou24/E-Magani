      ...
      <div id="resultPharmacie" style="display: none">
        ...
        <div class="row staff-grid-row">
                ...
                <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
                    <div class="profile-widget">
                        <div class="text-center">
                        <a href="{{URL::to('/')}}" class="brand-link"> <img class="img-fluid" src="{{ URL::to('storage/files/'. $lists->pharmacie_image) }}" alt="Image de la pharmacie" style="max-width:200px;margin-bottom:10px;"></a>
