...
<body onload = "getLocation();">
    ...
    <div class="container">
      ...
      <a class="btn btn-success float-right mb-4" href="" data-toggle="modal" data-target="#ajouterPharmacie">Ajouter Nouveau pharmacie</a>
          <table class="table">
                                    ...
                                    <div class="modal right fade" id="editPharmacie{{$pharmacie->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                      <div class="modal-dialog">
                                        ...
                                        <div class="modal-header">
                                            <h4 class="modal-title" id="staticBackdropLabel">Modifier Pharmacie</h4>
                                            ...
                                            <button class="btn btn-warning btn-block">Modifier Employé</button>
                                                                ...
                                                                <div class="modal right fade" id="deletePharmacie{{$pharmacie->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                      <div class="modal-content">
                                                                        <div class="modal-header">
                                                                          <h4 class="modal-title" id="staticBackdropLabel">Supprimer Pharmacie</h4>
                                                                          <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close">
                                                                            <span aria-hidden="true">&times;</span>
                                                                          </button>
                                                                        </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="form-group">
                ...
                <input type="hidden" class="form-control" id="latitude" placeholder="Entrer pharmacie image" name="latitude" >        
                <input type="hidden" class="form-control" id="longitude" placeholder="Entrer pharmacie image" name="longitude" >
          <div class="modal-footer">
    ...
    <script type="text/javascript">
      ...
      function showPosition(position) {
        document.querySelector('.form-horizontal input[name = "latitude"]').value = position.coords.latitude;
        document.querySelector('.form-horizontal input[name = "longitude"]').value = position.coords.longitude;
      }
