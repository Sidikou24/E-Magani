                              ...
                              <td>
                                  <select name="produit_id[]" id="produit_id" class="form-control produit_id">
                                    <option value="">Selectionner Produit</option>
                                        ...
                                        <option data-prix="{{$produit->prix}}"data-lot="{{$produit->num_lot}}" value="{{$produit->id}}">{{$produit->name}}</option>
                                        @endforeach
                                  </select>
                              </td>
                              <td>
        ...
        // })
            $('.add_more').on('click',function() {
               ...
               var tr = '<tr><td class"no">' + numberofrow + '</td>' +
                        ...
                        '</select> </td>' +
                        '<td> <input type="number" name="quantite[]" id="quantite" class="form-control quantite"> </td>' +
