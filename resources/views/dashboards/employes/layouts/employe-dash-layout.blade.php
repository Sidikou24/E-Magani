  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{Auth::user()->image}}" class="img-circle elevation-2 employe_picture" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block employe_name">{{Auth::user()->name }}</a>
        </div>
      </div>
...
<script>
  ...
  $(function () {
    $('#employeInfoForm').on('submit', function(e) {
        e.preventDefault();
        $.ajax({
          ...
          success: function(data) {
            if (data.status == 0) {
              ...
              $('.employe_name').each(function () {
                $(this).html($('#employeInfoForm').find($('input[name="name"]')).val());
              });
              alert(data.msg);
            }
          }
      ...
      $('#employe_image').ijaboCropTool({
          preview : '.employe_picture',
          setRatio:1,
          allowedExtensions: ['jpg', 'jpeg','png'],
          buttonsText:['CROP','QUIT'],
          buttonsColor:['#30bf7d','#ee5155', -15],
          processUrl:'{{ route("employeImageUpdate") }}',
       ...
       $('#changePasswordEmployeForm').on('submit', function(e) {
        e.preventDefault();
        $.ajax({
          url: $(this).attr('action'),
          method: $(this).attr('method'),
          ...
          success: function(data) {
            if (data.status == 0) {
              ...
              // $(this).html($('#changePasswordEmployeForm').find($('input[name="name"]')).val());
              $('#changePasswordEmployeForm')[0].reset()
              alert(data.msg);
            }
          }
        });
