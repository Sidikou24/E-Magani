      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active"><a href="{{route('employe.profile')}}">User Profile</a></li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
          ...
          <div class="card card-primary card-outline">
            <div class="card-body box-profile">
              <div class="text-center">
                <img class="profile-user-img img-fluid img-circle employe_picture" src="{{Auth::user()->image}}" alt="User profile picture">
              </div>

              <h3 class="profile-username text-center employe_name">{{Auth::user()->name}}</h3>

              <p class="text-muted text-center" >{{Auth::user()->fonction}}</p>
              <input type="file" name="employe_image" id="employe_image"  style="opacity:0;height:1px;dispaly:none;" >
            ...
            <div class="card-body">
              <div class="tab-content">
                <div class="active tab-pane" id="personnal_info">
                  <form class="form-horizontal" method="POST" action="{{route('employeUpdateInfo')}}" id="employeInfoForm">
                    {{ csrf_field() }}
              ...
              <div class=" tab-pane" id="change_password">
                <form class="form-horizontal" action="{{route('employeChangePassword')}}" method="POST" id="changePasswordEmployeForm">
                   {{ csrf_field() }}
                   @if(Session::get('success'))
                    <div class="alert alert-success">
                      {{Session::get('success')}}
