    ...
    <div class="container-fluid">
        <div class="col-lg-12">
            <div class="row">
                <div class="col-md-9">
                    <div class="card">
                        <h4 class="card-header" style="background:#2ecc71; color:#fff ">
                            <marquee behavior="" direction="">Bienvenue Pharmacien: {{ Auth::user()->name }} {{ Auth::user()->prenom }} dans la La
                                Gestions des Employer de la Pharmacie: {{ $pharmacie->name }}</marquee>
                        </h4><br>
                        <div class="card-header">
                            <h4 style="float: left"> Ajouter Nouveau employe</h4>
                            <a href="#" style="float: right" class="btn btn-dark" data-toggle="modal"
                                data-target="#addUser">
                                <i class="fa fa-plus"></i> Ajouter Nouveau employe</a>
                        </div>
                            ...
                            <tbody id="myTable">
                                @foreach ($employes as $key => $employe)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="" data-toggle="modal" data-target="#editUser{{ $employe->id }}"
                                                    class="btn btn-info btnt-sm"><i class="fa fa-edit"></i> Modifier
                                                </a>
                                    ...
                                    <div class="modal right fade" id="editUser{{ $employe->id }}"
                                        data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                        aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="staticBackdropLabel">Modifier Employe
                                                    </h4>
                                                    ...
                                                    <form action="{{ route('users.update', $employe->id) }}" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="name" name="name"
                                                                value="{{ $employe->name }}" required autocomplete="name"
                                                                autofocus placeholder="Nom de l'enregistré">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="prenom" class="">Prénom *</label>
                                                            <input type="text" class="form-control" id="prenom"
                                                                name="prenom" value="{{ $employe->prenom }}" required
                                                                autocomplete="prenom" autofocus
                                                                placeholder="Prenom de l'enregisté">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="inputEmail">Email</label>
                                                            <input type="email" class="form-control" id="inputEmail"
                                                                placeholder="Email" value="{{ $employe->email }}"
                                                                name="email" require>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="fonction" class="">Fonction *</label>
                                                            <input type="text" id="fonction" readonly class="form-control"
                                                                name="fonction" list="fon" required pattern="[Ee]mployé"
                                                                value="employé">
                                                            <datalist id="fon">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="dateNaiss" class="">Date de
                                                                Naissance</label>
                                                            <input type="date" class="form-control" id="dateNaiss"
                                                                name="dateNaiss" autocomplete="dateNaiss" autofocus
                                                                value="{{ $employe->dateNaiss }}">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="pays" class="">Pays *</label>
                                                            <input type="text" class="form-control" id="pays" name="pays"
                                                                value="{{ $employe->pays }}" required autocomplete="pays">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="ville" class="">Ville *</label>
                                                            <input type="text" class="form-control" id="ville"
                                                                name="ville" value="{{ $employe->ville }}" required
                                                                autocomplete="ville" autofocus>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="codePostal" class="">Code postal
                                                                *</label>
                                                            <input type="text" class="form-control" id="codePostal"
                                                                name="codePostal" value="{{ $employe->codePostal }}"
                                                                required autocomplete="codePostal" autofocus>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="numTel" class="">Téléphone</label>
                                                            <input type="text" class="form-control" id="numTel"
                                                                name="numTel" value="{{ $employe->numTel }}" required
                                                                autocomplete="numTel" autofocus>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button class="btn btn-warning btn-block">Modifier
                                                                Employé</button>
                                                        </div>
                                                    </form>
                                                </div>
                                    ...
                                    <div class="modal right fade" id="deleteUser{{ $employe->id }}"
                                        data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                        aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="staticBackdropLabel">Supprimer Employe
                                                    </h4>
                                                    <button type="button" class="btn-close" data-dismiss="modal"
                                                        aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                    ...
                    <form action="{{ route('inscrireEmploye', $pharmacie->id) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}"
                                required autocomplete="name" autofocus placeholder="Nom de l'enregistré">
                        </div>
                        <div class="form-group">
                            <label for="prenom" class="">Prénom *</label>
                        ...
                        <div class="form-group">
                            <label for="fonction" class="">Fonction *</label>
                            <input type="text" id="fonction" readonly class="form-control" value="employé" name="fonction"
                                list="fon" required pattern="[Ee]mployé">
                            <datalist id="fon">
                                <option>employé</option>
                            </datalist>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="numTel" name="email"
