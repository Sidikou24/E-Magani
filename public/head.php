                ...
                <div class="top-nav s-12 l-10">
                    ...
                    <ul class="right chevron">
                        ...
                        <li class="nav-item px-2">
                            <a class="submit-form button background-primary border-radius text-white" href="/connexion">Connexion</a>
                        </li>
                        <li class="nav-item px-2">
                            <a class="submit-form button background-primary border-radius text-white" href="/user">S'inscrire</a>
                    </ul>
                </div>
            </div>
        </nav>
